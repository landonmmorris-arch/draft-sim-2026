...
const NFLMockDraft = () => {
  ...
  const generateProspects = () => {
    ...
    const prospects = [
      ...
      { name: 'David Bailey', position: 'EDGE', school: 'Texas Tech', grade: 96.5, headshot: 'https://a.espncdn.com/i/headshots/college-football/players/full/4685248.png', analysis: 'Elite pass rusher with rare blend of speed and power. Bailey showcases exceptional get-off and bend around the edge. His relentless motor and array of pass-rush moves make him a game-changing presence off the edge.' },
      { name: 'Rueben Bain Jr.', position: 'EDGE', school: 'Miami', grade: 96, headshot: 'https://a.espncdn.com/i/headshots/college-football/players/full/4870618.png', analysis: 'Explosive edge defender with natural pass-rush instincts and exceptional athleticism. Bain excels at converting speed to power and shows advanced hand usage for his experience level. Projects as an impact starter from day one.' },
      ...
      { name: 'Makai Lemon', position: 'WR', school: 'USC', grade: 91.5, headshot: 'https://a.espncdn.com/i/headshots/college-football/players/full/4870795.png', analysis: 'Big-bodied receiver with excellent catch radius and contested-catch ability. Lemon uses his size well to box out defenders and makes tough grabs look routine. His red zone presence and physicality add immediate value.' },
      { name: 'Avieon Terrell', position: 'CB', school: 'Clemson', grade: 91, headshot: 'https://a.espncdn.com/i/headshots/college-football/players/full/4870988.png', analysis: 'Versatile defensive back with elite speed and coverage skills. Terrell shows the ability to match up against any receiver type and excels in press-man coverage. His awareness and ball skills translate to consistent playmaking ability.' },
      ...
      { name: 'Keldric Faulk', position: 'EDGE', school: 'Auburn', grade: 90, headshot: 'https://a.espncdn.com/i/headshots/college-football/players/full/4870707.png', analysis: 'Explosive edge rusher with quick first step and violent hands. Faulk shows the ability to win with speed or power and has developed a nice array of counter moves. His relentless effort and motor make him a consistent disruptor.' },
      { name: 'Cashius Howell', position: 'EDGE', school: 'Texas A&M', grade: 89.5, headshot: 'https://a.espncdn.com/i/headshots/college-football/players/full/4710752.png', analysis: 'Powerful edge defender with exceptional length and strength. Howell sets a strong edge against the run and shows improving pass-rush skills. His high upside and physicality make him an intriguing developmental prospect.' },
      ...
      { name: 'Trevor Goosby', position: 'OT', school: 'Texas', grade: 73, headshot: 'https://a.espncdn.com/i/headshots/college-football/players/full/4918430.png' },
      { name: 'T.J. Parker', position: 'LB', school: 'Clemson', grade: 72.5, headshot: 'https://a.espncdn.com/i/headshots/college-football/players/full/4870886.png' },
      { name: 'Harold Perkins Jr.', position: 'LB', school: 'LSU', grade: 72, headshot: 'https://a.espncdn.com/i/headshots/college-football/players/full/4685502.png' },
      { name: 'Taurean York', position: 'LB', school: 'Texas A&M', grade: 71.5, headshot: 'https://a.espncdn.com/i/headshots/college-football/players/full/4917859.png' },
      { name: 'Ja\'Kobi Lane', position: 'WR', school: 'USC', grade: 71, headshot: 'https://a.espncdn.com/i/headshots/college-football/players/full/4870847.png' },
      { name: 'Austin Barber', position: 'OT', school: 'Florida', grade: 70.5, headshot: 'https://a.espncdn.com/i/headshots/college-football/players/full/4597310.png' },
      { name: 'Matayo Uiagalelei', position: 'EDGE', school: 'Oregon', grade: 70, headshot: 'https://a.espncdn.com/i/headshots/college-football/players/full/4871052.png' },
      { name: 'Davison Igbinosun', position: 'CB', school: 'Ohio State', grade: 69.5, headshot: 'https://a.espncdn.com/i/headshots/college-football/players/full/4832035.png' },
      { name: 'Tyreak Sapp', position: 'DT', school: 'Florida', grade: 69, headshot: 'https://a.espncdn.com/i/headshots/college-football/players/full/4889957.png' },
      { name: 'Malik Muhammad', position: 'CB', school: 'Texas', grade: 68.5, headshot: 'https://a.espncdn.com/i/headshots/college-football/players/full/4870953.png' },
      { name: 'Jake Golday', position: 'LB', school: 'Cincinnati', grade: 68, headshot: 'https://a.espncdn.com/i/headshots/college-football/players/full/4877652.png' },
      { name: 'Emmanuel McNeil-Warren', position: 'S', school: 'Toledo', grade: 67.5, headshot: 'https://a.espncdn.com/i/headshots/college-football/players/full/4837186.png' },
      { name: 'Max Klare', position: 'TE', school: 'Ohio State', grade: 67, headshot: 'https://a.espncdn.com/i/headshots/college-football/players/full/4833029.png' },
      { name: 'Lee Hunter', position: 'DT', school: 'Texas Tech', grade: 66.5, headshot: 'https://a.espncdn.com/i/headshots/college-football/players/full/4431551.png' },
      { name: 'Logan Jones', position: 'C', school: 'Iowa', grade: 66, headshot: 'https://a.espncdn.com/i/headshots/college-football/players/full/4686907.png' },
      { name: 'Zxavian Harris', position: 'DT', school: 'Ole Miss', grade: 65.5, headshot: 'https://a.espncdn.com/i/headshots/college-football/players/full/4685365.png' },
      { name: 'Connor Lew', position: 'C', school: 'Auburn', grade: 65, headshot: 'https://a.espncdn.com/i/headshots/college-football/players/full/4870866.png' },
      { name: 'Domani Jackson', position: 'CB', school: 'Alabama', grade: 64.5, headshot: 'https://a.espncdn.com/i/headshots/college-football/players/full/4685402.png' },
      { name: 'Jake Slaughter', position: 'C', school: 'Florida', grade: 64, headshot: 'https://a.espncdn.com/i/headshots/college-football/players/full/4682506.png' },
      { name: 'John Mateer', position: 'QB', school: 'Oklahoma', grade: 63.5, headshot: 'https://a.espncdn.com/i/headshots/college-football/players/full/4915980.png' },
      { name: 'Drew Allar', position: 'QB', school: 'Penn State', grade: 63, headshot: 'https://a.espncdn.com/i/headshots/college-football/players/full/4714771.png' },
      { name: 'Carter Smith', position: 'OT', school: 'Indiana', grade: 62.5, headshot: 'https://a.espncdn.com/i/headshots/college-football/players/full/4819239.png' },
      { name: 'Michael Taaffe', position: 'S', school: 'Texas', grade: 62, headshot: 'https://a.espncdn.com/i/headshots/college-football/players/full/4880346.png' },
      { name: 'Eric Singleton Jr.', position: 'WR', school: 'Auburn', grade: 61.5, headshot: 'https://a.espncdn.com/i/headshots/college-football/players/full/5095360.png' },
      { name: 'Austin Siereveld', position: 'OT', school: 'Ohio State', grade: 61, headshot: 'https://a.espncdn.com/i/headshots/college-football/players/full/4917984.png' },
      { name: 'Kaytron Allen', position: 'RB', school: 'Penn State', grade: 60.5, headshot: 'https://a.espncdn.com/i/headshots/college-football/players/full/4685246.png' },
      { name: 'Chris Brazzell II', position: 'WR', school: 'Tennessee', grade: 60, headshot: 'https://a.espncdn.com/i/headshots/college-football/players/full/5091739.png' },
      { name: 'Antonio Williams', position: 'WR', school: 'Clemson', grade: 59.5, headshot: 'https://a.espncdn.com/i/headshots/college-football/players/full/5081432.png' },
      { name: 'Garrett Nussmeier', position: 'QB', school: 'LSU', grade: 59, headshot: 'https://a.espncdn.com/i/headshots/college-football/players/full/4567747.png' },
      { name: 'Carson Beck', position: 'QB', school: 'Miami', grade: 58.5, headshot: 'https://a.espncdn.com/i/headshots/college-football/players/full/4430841.png' },
      { name: 'Jadarian Price', position: 'RB', school: 'Notre Dame', grade: 58, headshot: 'https://a.espncdn.com/i/headshots/college-football/players/full/4685512.png' },
      { name: 'Zachariah Branch', position: 'WR', school: 'Georgia', grade: 57.5, headshot: 'https://a.espncdn.com/i/headshots/college-football/players/full/4870612.png' },
      { name: 'Kamari Ramsey', position: 'S', school: 'USC', grade: 57, headshot: 'https://a.espncdn.com/i/headshots/college-football/players/full/4685518.png' },
      { name: 'A\'Mauri Washington', position: 'DT', school: 'Oregon', grade: 56.5, headshot: 'https://a.espncdn.com/i/headshots/college-football/players/full/4899488.png' },
      { name: 'Quincy Rhodes Jr.', position: 'EDGE', school: 'Arkansas', grade: 56, headshot: 'https://a.espncdn.com/i/headshots/college-football/players/full/4918136.png' },
      { name: 'LaNorris Sellers', position: 'QB', school: 'South Carolina', grade: 55.5, headshot: 'https://a.espncdn.com/i/headshots/college-football/players/full/4875127.png' },
      ...
      { name: 'Jaishawn Barham', position: 'LB', school: 'Michigan', grade: 54.5, headshot: 'https://a.espncdn.com/i/headshots/college-football/players/full/4685266.png' },
      { name: 'Michael Trigg', position: 'TE', school: 'Baylor', grade: 54, headshot: 'https://a.espncdn.com/i/headshots/college-football/players/full/4594749.png' },
      { name: 'Deion Burks', position: 'WR', school: 'Oklahoma', grade: 54, headshot: 'https://a.espncdn.com/i/headshots/college-football/players/full/4683151.png' },
      { name: 'Derrick Moore', position: 'EDGE', school: 'Michigan', grade: 53 },
      { name: 'Zane Durant', position: 'DT', school: 'Penn State', grade: 53 },
      { name: 'Darrell Jackson Jr.', position: 'DT', school: 'Florida State', grade: 52 },
      { name: 'Josiah Trotter', position: 'LB', school: 'Missouri', grade: 52 },
      { name: 'Dontay Corleone', position: 'DT', school: 'Cincinnati', grade: 51 },
      { name: 'Anthony Lucas', position: 'DT', school: 'USC', grade: 51 },
      { name: 'Jeremiah Cobb', position: 'RB', school: 'Auburn', grade: 50 },
      { name: 'Mikail Kamara', position: 'EDGE', school: 'Indiana', grade: 50 },
      { name: 'Tacario Davis', position: 'CB', school: 'Washington', grade: 49 },
      { name: 'Jack Endries', position: 'TE', school: 'Texas', grade: 49 },
  ...
  const submitCounterTradeDown = () => {
    ...
    if (Math.random() < newAcceptChance) {
      ...
      const trade = {
        ...
        pickGiven: pick,
        pickReceived: option.targetPickNum,
        additionalPicks: selectedCounterPicks.map((p: DraftPick) => `${p.year} Round ${p.round}`),
        forUser: true,
        userInitiated: true
      };
  ...
  const offerTradeUp = (option: any) => {
    if (Math.random() < option.acceptChance) {
      ...
      const picksGivenDisplay = option.useFuturePicks
        ? option.additionalPicks.map((p: DraftPick) => `${p.year} Round ${p.round}`)
        : option.userPickInRound
          ? [`Pick #${option.userPickInRound}`, ...option.additionalPicks.map((p: DraftPick) => `${p.year} Round ${p.round}`)]
          : option.additionalPicks.map((p: DraftPick) => `${p.year} Round ${p.round}`);
